...
public class ReflectionUtils {
	 ...
	 * 直接读取对象属性值, 无视private/protected修饰符, 不经过getter函数.
	 */
	public static Object getFieldValue(final Object obj, final String fieldName, boolean require) {
	 ...
	 * @param args 对象属性
	 */
	public static void setNullProperties(Object target, String... args){
		if(!ArrayUtils.isEmpty(args)){
			Arrays.stream(args).forEach(str -> {
				setFieldValue(target, str, null);
			});
		}
	}
